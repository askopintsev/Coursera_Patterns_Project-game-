...
class GameSurface(ScreenHandle):
    ...
    def connect_engine(self, engine):
        ...
        self.successor.connect_engine(engine)  # FIXME save engine and send it to next in chain
...
class ProgressBar(ScreenHandle):
    ...
    def connect_engine(self, engine):
        self.engine = engine  # FIXME save engine and send it to next in chain
...
class InfoWindow(ScreenHandle):
    ...
    def connect_engine(self, engine):
        self.game_engine = engine  # FIXME set this class as Observer to engine and send it to next in chain
